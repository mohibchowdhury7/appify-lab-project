...
export default function PostComposer() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        const { data: presigned } = await AXIOS_INSTANCE.post('/api/storage/upload-url', {
      ...
      await AXIOS_INSTANCE.post('/api/posts', {
  ...
  const avatarUrl = user?.avatarUrl || txtImg;

  return (
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          <img src={avatarUrl} alt="Avatar" className="_txt_img" />
        </div>
        <div className="form-floating _feed_inner_text_area_box_form">
          <textarea
            ...
            maxLength={5000}
          />
          <label className="_feed_textarea_label">Write something ...
      ...
      <div className="_feed_inner_text_area_bottom">
        <div className="_feed_inner_text_area_item">
          <div className="_feed_inner_text_area_bottom_photo _feed_common">
            <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={() => fileInputRef.current?.click()}>
              ...
              {selectedFile ? selectedFile.name : 'Photo'}
            </button>
          ...
          <div className="_feed_inner_text_area_bottom_event _feed_common">
            <select
              ...
              style={{ border: 'none', background: 'transparent', color: '#666', fontSize: '14px', cursor: 'pointer' }}
            >
        ...
        {error && <p style={{ color: '#dc3545', fontSize: '13px', margin: '8px 0 0' }}>{error}</p>}
        <div className="_feed_inner_text_area_btn">
          <button type="button" className="_feed_inner_text_area_btn_link" onClick={handleSubmit} disabled={uploading}>
