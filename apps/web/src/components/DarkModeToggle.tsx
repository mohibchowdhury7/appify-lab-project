  ...
  return (
    <div className="_layout_mode_swithing_btn">
      <button type="button" className="_layout_swithing_btn_link" onClick={toggleTheme}>
        <div className="_layout_swithing_btn" style={isDark ? { left: 'calc(10px + 22px)' } : undefined}>
          <div className="_layout_swithing_btn_round" />
        </div>
        <div className="_layout_change_btn_ic1" style={isDark ? { visibility: 'hidden', opacity: 0 } : undefined}>
        ...
        <div className="_layout_change_btn_ic2" style={isDark ? { visibility: 'visible', opacity: 1 } : undefined}>
