...
import profile1Img from '../assets/images/profile-1.png';
...
export default function Header() {
  ...
  const notifications = [
    { img: friendReqImg, text: 'posted a link in your timeline.', name: 'Steve Jobs', time: '42 miniutes ago' },
    { img: profile1Img, text: 'An admin changed the name of the group', name: 'Freelacer usa', name2: 'Freelacer usa', time: '42 miniutes ago' },
    { img: friendReqImg, text: 'posted a link in your timeline.', name: 'Steve Jobs', time: '42 miniutes ago' },
  ];
      ...
      <div className="container _custom_container">
        <div className="_logo_wrap">
          <Link className="navbar-brand" to="/feed">
            <img src={logoImg} alt="Buddy Script" className="_nav_logo" />
          </Link>
        </div>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <Link to="/feed" className="nav-link _header_nav_link_active _header_nav_link">
            ...
            <li className="nav-item _header_nav_item" ref={notifyRef}>
              <span className="nav-link _header_nav_link _header_notify_btn" onClick={() => { setShowNotifications(!showNotifications); setShowNotifyMenu(false); }} style={{ cursor: 'pointer' }}>
                ...
                <div id="_notify_drop" className={`_notification_dropdown${showNotifications ? ' show' : ''}`} onClick={(e) => e.stopPropagation()}>
                  <div className="_notifications_content">
                    <h4 className="_notifications_content_title">Notifications</h4>
                    <div className="_notification_box_right" style={{ position: 'relative' }}>
                      <button type="button" className="_notification_box_right_link" onClick={() => setShowNotifyMenu(!showNotifyMenu)}>
                  ...
                  <div className="_notifications_drop_box">
                    <div className="_notifications_drop_btn_grp">
                      <button className={`_notifications_btn_link${notifyTab === 'all' ? '' : ''}`} onClick={() => setNotifyTab('all')} style={notifyTab === 'all' ? { background: '#1890FF', color: '#fff' } : undefined}>All</button>
                      <button className={`_notifications_btn_link1`} onClick={() => setNotifyTab('unread')} style={notifyTab === 'unread' ? { background: '#1890FF', color: '#fff' } : undefined}>Unread</button>
                    </div>
                        ...
                        <div className="_notification_box" key={i}>
                          ...
                          <div className="_notification_txt">
                            <p className="_notification_para">
                              ...
                              {n.name2 && <><span className="_notify_txt_link"> {n.name2}</span></>}
                            </p>
                            <div className="_nitification_time"><span>{n.time}</span></div>
                          </div>
                        </div>
                      ))}
                    </div>
          ...
          <div className="_header_nav_profile" ref={profileRef}>
            <div className="_header_nav_profile_image">
              <img src={user?.avatarUrl || profileImg} alt="Profile" className="_nav_profile_img" />
            </div>
            <div className="_header_nav_dropdown">
              <p className="_header_nav_para">{user ? `${user.firstName} ${user.lastName}` : 'Dylan Field'}</p>
              <button
              ...
              <div className="_nav_profile_dropdown _profile_dropdown" style={{ display: 'block' }}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <img src={user?.avatarUrl || profileImg} alt="Profile" className="_nav_drop_img" />
                  </div>
                  <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{user ? `${user.firstName} ${user.lastName}` : 'Dylan Field'}</h4>
                ...
                <ul className="_nav_dropdown_list">
                  <li className="_nav_dropdown_list_item">
                    <a href="#0" className="_nav_dropdown_link" onClick={(e) => e.preventDefault()}>
                  ...
                  <li className="_nav_dropdown_list_item">
                    <a href="#0" className="_nav_dropdown_link" onClick={(e) => { e.preventDefault(); setShowProfileDropdown(false); logout(); }}>
                      <div className="_nav_drop_info">
                        <span>
